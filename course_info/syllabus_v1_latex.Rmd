...
**Course Website:** [geog215-spds.rbind.io](https://geog215-spds.rbind.io)  
...
Office Hours: *223 Carolina (Hurston) Hall | Mon 11-12 pm, Thu 2-4 pm, Fri 2-3 pm or by appointment*
...
The class schedule is subject to change as needed. ***(Deliverables are due before class on the mentioned date)***
```{r}
# Read in schedule
...
wk_schedule %>%
  kable("latex", longtable= T, booktabs =T,align="lllll",linesep = "") %>%
