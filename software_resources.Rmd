...
```{r eval = FALSE}
p_df <- as.data.frame(installed.packages("/Library/Frameworks/R.framework/Versions/3.4/ Resources/library")) ## make sure to check this folder path and update the 3.X
